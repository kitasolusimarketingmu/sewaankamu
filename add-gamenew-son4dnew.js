		...
		if (window.location.href.includes("provider=pg") || window.location.href.includes("gid=pg")) {
		    if (isVisible) {
				...
				const htmlString = `
					...
					<div style="height:200px; width:170px; display:inline-block; text-align:center; vertical-align:top" bis_skin_checked="1">
					  <a target="_blank" href="`+href+`" bis_size="{&quot;x&quot;:191,&quot;y&quot;:1150,&quot;w&quot;:170,&quot;h&quot;:110,&quot;abs_x&quot;:191,&quot;abs_y&quot;:1150}">
					    <img src="https://imggalery.com/uploads/user_81/album_173/1777038120_2.gif" style="width:160px; cursor: pointer; border-radius: 30px;" bis_size="{&quot;x&quot;:196,&quot;y&quot;:1078,&quot;w&quot;:160,&quot;h&quot;:160,&quot;abs_x&quot;:196,&quot;abs_y&quot;:1078}" bis_id="bn_mvouyxcw1ygjgf1n47ifgj">
					    <div style="text-align:center; margin-top:5px" bis_skin_checked="1">Mahjong Ways OranX1000</div>
					  </a>
					</div>
				    `;
				...
				const htmlString2 = `
					...
					<div style="height:205px; width:185px; float:left; text-align:center; vertical-align:top;" bis_skin_checked="1">
					  <a onclick="`+onclick+`">
					    <img src="https://imggalery.com/uploads/user_81/album_173/1777038120_2.gif" style="width:160px; cursor: pointer; border-radius: 30px;">
					    <div style="text-align:center; margin-top:5px; cursor: pointer;" bis_skin_checked="1">Super SC MJ2</div>
					  </a>
					</div>
					...
					<div style="height:205px; width:185px; float:left; text-align:center; vertical-align:top;" bis_skin_checked="1">
					  <a onclick="`+onclick+`">
					    <img src="https://imggalery.com/uploads/user_81/album_173/1777038120_2.gif" style="width:160px; cursor: pointer; border-radius: 30px;">
					    <div style="text-align:center; margin-top:5px; cursor: pointer;" bis_skin_checked="1">Mahjong Ways OranX1000</div>
					  </a>
					</div>
				`;
		    	...
		    	const htmlString = `
					...
					<figure class="gameitem">
					  <img src="https://imggalery.com/uploads/user_81/album_173/1777038120_2.gif" style="width:150px; border-radius: 30px;">
					  <figcaption style="text-align:center; margin-top:5px;">Mahjong Ways OranX1000</figcaption>
					</figure>
				    `;
			...
			const htmlString3 = `
				...
				<div class="gameContent">
				  <div class="tnimg">
					  <a `+(window.location.pathname.includes("m/userarea.php") ? 'href="'+href5+'"' : 'onclick="'+onclick5+'"')+`>
