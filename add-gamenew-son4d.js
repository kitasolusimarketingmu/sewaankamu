window.addEventListener('DOMContentLoaded', function() {
	if (window.location.pathname === "/" || window.location.pathname === "/index.php") {
	    ...
	    const isVisible = document.getElementById("mobilelogin").offsetParent !== null;
...
window.addEventListener('DOMContentLoaded', function() {
	...
	const isUserAreaM = window.location.href.includes("/m/userarea.php");
	var ppslot = document.getElementById('ppslot');
	var pgslot = document.getElementById('pgslot')

	var cssd = 'height:205px; width:185px; float:left; text-align:center; vertical-align:top;';
	var cssm = 'height:190px; width:170px;display:inline-block; text-align:center; vertical-align:top';

	setTimeout(function(){
		if (isUserArea) {
			if (ppslot != undefined) {
				const elements = document.querySelectorAll("*");
				let MahjongWins3 = null;
				let MahjongWins2 = null;

				elements.forEach(el => {
				  if (el.textContent.trim().includes("Mahjong Wins 3 - Black Scatter")) {
				    const parent = el.closest("a");
				    if (parent && parent.href) {
				      MahjongWins3 = parent.href;
				    }
				  }
				});

				elements.forEach(el => {
				  if (el.textContent.trim().includes("Mahjong Wins 2")) {
				    const parent = el.closest("a");
				    if (parent && parent.href) {
				      MahjongWins2 = parent.href;
				    }
				  }
				});

				const htmlString = `
					<div style="`+(isUserAreaM ? cssm : cssd)+`" bis_skin_checked="1">
					   <a href="`+MahjongWins2+`" bis_size="{&quot;x&quot;:231,&quot;y&quot;:694,&quot;w&quot;:170,&quot;h&quot;:103,&quot;abs_x&quot;:231,&quot;abs_y&quot;:694}">
					...
					<div style="`+(isUserAreaM ? cssm : cssd)+`" bis_skin_checked="1">
					   <a href="`+MahjongWins3+`" bis_size="{&quot;x&quot;:61,&quot;y&quot;:694,&quot;w&quot;:170,&quot;h&quot;:103,&quot;abs_x&quot;:61,&quot;abs_y&quot;:694}">
				...
				const elements = document.querySelectorAll("*");
				let MahjongWays1 = null;
				let MahjongWays2 = null;

				elements.forEach(el => {
				  if (el.textContent.trim().includes("Mahjong Ways")) {
				    const parent = el.closest("a");
				    if (parent && parent.href) {
				      MahjongWays1 = parent.href;
				    }
				  }
				});

				elements.forEach(el => {
				  if (el.textContent.trim().includes("Mahjong Ways 2")) {
				    const parent = el.closest("a");
				    if (parent && parent.href) {
				      MahjongWays2 = parent.href;
				    }
				  }
				});
				...
				const htmlString = `
					<div style="`+(isUserAreaM ? cssm : cssd)+`" bis_skin_checked="1">
					   <a href="`+MahjongWays1+`" bis_size="{&quot;x&quot;:58,&quot;y&quot;:1099,&quot;w&quot;:170,&quot;h&quot;:110,&quot;abs_x&quot;:58,&quot;abs_y&quot;:1099}">
					...
					<div style="`+(isUserAreaM ? cssm : cssd)+`" bis_skin_checked="1">
					   <a href="`+MahjongWays2+`" bis_size="{&quot;x&quot;:231,&quot;y&quot;:1099,&quot;w&quot;:170,&quot;h&quot;:110,&quot;abs_x&quot;:231,&quot;abs_y&quot;:1099}">
