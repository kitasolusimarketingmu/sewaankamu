...
function addElementAtIndex(containerId, newElement, index) {
    ...
    document.addEventListener("DOMContentLoaded", function() {
		...
		var sliderGame = $('<style>.slider-container{overflow:hidden;width:850px;margin-top: 11px;white-space:nowrap;position:relative}.slider-track{display:flex;gap:10px;animation:scroll 10s linear infinite}.slider-track img{width:140px;height:auto;border-radius:10px}@keyframes scroll{from{transform:translateX(0)}to{transform:translateX(-50%)}}</style><div class=slider-container><div class=slider-track><img src=https://mawartt.sgp1.cdn.digitaloceanspaces.com/mahjongwayspng.png> <img src=https://mawartt.sgp1.cdn.digitaloceanspaces.com/luckynekopng.png> <img src=https://mawartt.sgp1.cdn.digitaloceanspaces.com/luckyfortunespng.png> <img src=https://mawartt.sgp1.cdn.digitaloceanspaces.com/goldenlionpng.png> <img src=https://mawartt.sgp1.cdn.digitaloceanspaces.com/gatesolympuspng.png> <img src=https://mawartt.sgp1.cdn.digitaloceanspaces.com/gatesofolympuspng.png> <img src=https://mawartt.sgp1.cdn.digitaloceanspaces.com/wildbanditopng.png> <img src=https://mawartt.sgp1.cdn.digitaloceanspaces.com/treasureofaztecpng.png> <img src=https://mawartt.sgp1.cdn.digitaloceanspaces.com/sweetbonanzapng.png> <img src=https://mawartt.sgp1.cdn.digitaloceanspaces.com/starlightpng.png></div></div>');
