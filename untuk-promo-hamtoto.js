	        	...
	        	if (isPromotionPage()) {
				    ...
				    style.innerHTML = `
						...
						.promosi-content-container .promosi-content .promosi-btn-wrapper .btn-promo#btn-promo-more {
						        background-image: linear-gradient(to bottom, #fae27b 0%, #c6b200 100%) !important;
								color: #000 !important;
								width: 100% !important;
								height: 76px !important;
								box-shadow: inset 0 0 5px 3px #edd44d, inset 0 2px 0 0 #fff, inset 0 0 0 2px #eddc4c, 3px 3px 3px 1px rgba(0, 0, 0, .2);
								border-radius: 0px 5px 5px 0px !important;
								margin-top: 0px !important;
								padding: 2px !important;
								border: 1px solid #f7f72a;
						}
