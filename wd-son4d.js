    document.addEventListener('DOMContentLoaded', () => {
        ...
        style.textContent = `
            .google-wrapper p,.item-service h1{text-transform:uppercase;font-weight:700!important}.count-item{font-size:1.8rem;background:#322556;padding:.3rem .5rem;color:#fff!important;border-radius:10px;font-weight:700}.wrapper-service{display:flex;align-items:center;flex-wrap:wrap;justify-content:center;border-radius:10px;margin-top:1.3rem;border:3px solid #42525d;padding:.8rem}.status-wrapper,.status-wrapper-mem{display:flex;align-items:center;justify-content:center}.status-wrapper p{margin-right:.6rem!important}.item-service{margin-right:3rem}.item-service:last-child{margin-right:0}.item-service h1{font-size:2.2rem;margin-top:7px!important}.google-wrapper{background:#fff;padding:1.7rem;width:18rem;height:.5rem;border-radius:10px;position:relative}.google-wrapper img{position:absolute;width:2rem;top:9px;left:10px}.item-service p{color:#fff}.google-wrapper p{position:absolute;left:3.4rem;top:.6rem;font-size:1.5rem!important;color:#000!important}
        `;
        ...
        $(' <div class="wrapper-service"><div class="item-service"><h1>Deposit</h1> <div class="status-wrapper"><p>Rata-Rata</p> <p><span class="count-item">1</span> Menit</p></div> <div class="progress21 progress-moved2"><div class="progress-bar21"></div> </div>  </div> <div class="item-service"><h1>Withdraw</h1> <div class="status-wrapper"><p>Rata-Rata</p> <p><span class="count-item">3</span> Menit</p></div> <div class="progress21 progress-moved11"><div class="progress-bar31"></div> </div> </div> <div class="item-service"><h1>Member Online</h1> <div class="status-wrapper-mem"><p> </p> <p><span class="count-item">'+ memberUser +'</span> Member</p></div>  </div> <div class="item-service"><p style="text-align: center;">Ketik Di Google:</p> <div class="google-wrapper"><img src="https://iili.io/3R5ov8F.md.png" /> <p>SON4D</p></div></div> </div>').insertBefore(".provider-group");
    });
